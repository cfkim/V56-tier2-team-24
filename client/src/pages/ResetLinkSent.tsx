            ...
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="font-nunito text-base text-gray-600">
                  Please check your email to reset your password. The link will
                  expire in 1 hour.
                </p>
              </div>
              ...
              <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                <p className="font-nunito text-sm text-blue-800">
                  ...
                  folder or try requesting a new link.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-3">
                <Link
                  to="/password/forgot"
                  className="font-nunito rounded-lg bg-[#082368] px-6 py-3 text-center font-semibold text-white transition-colors hover:bg-[#061a4a]"
                >
                  Send Another Link
                </Link>
                <Link
                  to="/login"
                  className="font-nunito text-center text-[#082368] underline hover:no-underline"
                >
                  Back to Login
                </Link>
              </div>
